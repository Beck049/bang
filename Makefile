...
TARGETS=main
main_OBJ=basic.o cJSON.o list.o shuffle.o player.o game.o init_card.o init_character.o init_game.o event.o game_play.o draw.o select.o discard.o dodge.o main.o
